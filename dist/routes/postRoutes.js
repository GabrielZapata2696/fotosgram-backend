...
postRoutes.post('/subir', [autenticacion_1.validaToken], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.files) {
...
postRoutes.get('/imagen/:userid/:img', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
